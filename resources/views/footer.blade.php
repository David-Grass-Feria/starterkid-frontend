<footer class="bodyColor">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
      ...
      <div class="mt-10 flex justify-center space-x-10">
        ...
        <a href="{{$settingOrganizationFacebookUrl}}" title="{{__('Facebook')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationTwitterUrl}}" title="{{__('Twitter/X')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationInstagramUrl}}" title="{{__('Instagram')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationYoutubeUrl}}" title="{{__('Youtube')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationLinkedinUrl}}" title="{{__('Linkedin')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationPinterestUrl}}" title="{{__('Pinterest')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationGithubUrl}}" title="{{__('Github')}}" target="_blank" class="settingFontColor">
        ...
        <a href="{{$settingOrganizationWikipediaUrl}}" title="{{__('Wikipedia')}}" target="_blank" class="settingFontColor">
