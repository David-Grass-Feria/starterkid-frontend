<div class="mt-5 xl:mt-20">
    ...
    <div class="relative isolate">
      ...
      <div class="mx-auto lg:flex lg:items-center lg:gap-x-10">
        ...
        <livewire:starterkid-frontend::show-image lazy width="{{config('starterkid.image_width_height_attributes.medium.width')}}" height="{{config('starterkid.image_width_height_attributes.medium.height')}}" imgSrc="{{$imgSrc}}" imgAlt="{{$imgAlt}}" class="rounded-3xl shadow-lg ring-1 ring-primary w-full md:max-w-md mx-auto xl:max-w-lg" />
        </div>
      </div>
    </div>
  </div>