<div wire:key="press_item_{{$recordId}}" class="relative flex items-center space-x-3 rounded-lg border border-primary bg-white px-6 py-5">
    ...
    <div class="min-w-0 flex-1 text-font_primary">
      <a href="{{$href}}" title="{{$hrefTitle}}" class="focus:outline-none">
