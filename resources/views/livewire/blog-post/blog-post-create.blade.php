<div>
        <x-starterkid::starterkid.card>
                ...
                <x-starterkid::starterkid.form.slug wire:model="slug" slug="{{url('/')}}/{{config('starterkid-frontend.blog_post_slug')}}/" for="slug" id="slug" type="text" label="{{__('Slug')}}" required/>
